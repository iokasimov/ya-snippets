...
main = do
 print `ha_` Merge @List @List @List `ho` mutate `har_` [1,2,3,4] `hjd'tb` [5,6,7]
 output `ha` Caret `har'st` Tab
 print `ha_` Merge @List @(Nonempty List) @(Nonempty List) `ho` mutate `har_` [1,2,3,4] `hjd'tb` [5,6,7]
 output `ha` Caret `har'st` Tab
 print `ha_` Merge @(Nonempty List) @List @List `ho` mutate `har_` [1,2,3,4] `hjd'tb` [5,6,7]
 output `ha` Caret `har'st` Tab
 print `ha_` Merge @(Nonempty List) @(Nonempty List) @(Nonempty List) `ho` mutate `har_` [1,2,3,4] `hjd'tb` [5,6,7]
 output `ha` Caret `har'st` Tab
 {-
